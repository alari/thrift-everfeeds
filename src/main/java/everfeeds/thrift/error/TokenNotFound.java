...
public class TokenNotFound extends Exception implements org.apache.thrift.TBase<TokenNotFound, TokenNotFound._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TokenNotFound");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TokenNotFound.class, metaDataMap);
  }
   ...
   */
  public TokenNotFound(TokenNotFound other) {
    if (other.isSetErrMsg()) {
      this.errMsg = other.errMsg;
    }
  }

  public TokenNotFound deepCopy() {
    return new TokenNotFound(this);
  }
  ...
  public TokenNotFound setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TokenNotFound)
      return this.equals((TokenNotFound)that);
    return false;
  }

  public boolean equals(TokenNotFound that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TokenNotFound other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TokenNotFound typedOther = (TokenNotFound)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TokenNotFound(");
    boolean first = true;
