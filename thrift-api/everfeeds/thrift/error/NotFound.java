...
public class NotFound extends Exception implements org.apache.thrift.TBase<NotFound, NotFound._Fields>, java.io.Serializable, Cloneable {
  ...
  public NotFound setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public int compareTo(NotFound other) {
    ...
    NotFound typedOther = (NotFound)other;
